...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 block3">
            ...
            <h2 align="center">Если Вы на этой странице, значит что то пошло не так...</h2>
            <h3>либо некорректный url</h3>
            <h3>либо ошибка в логине или пароле</h3>
            <h3>ну может ещё что то сломалось...</h3>
        </div>
    </div>
    <div class="row">
